...
def build_model(args, num_classes=11003):
    # Check if enhanced RDE is requested
    if getattr(args, 'use_enhanced_rde', False):
        from .enhanced_rde import build_enhanced_model
        return build_enhanced_model(args, num_classes)
    else:
    model = RDE(args, num_classes)
        # Note: Do not convert to fp16 to maintain compatibility
