...
if __name__ == '__main__':
    ...
    sub = '/root/work/RDE-main/home/qinyang/projects/Cross-modal/ReID/2024-CVPR-RDE-1006/run_rde/RSTPReid/20240316_232415_RDE_TAL+sr0.3_tau0.015_margin0.1_n0.0'
    parser.add_argument("--config_file", default=f'{sub}/configs.yaml')
    args = parser.parse_args()
    args = load_train_configs(args.config_file)
    args.root_dir = '/root/work/RDE-main/2024-CVPR-RDE/datasets'
